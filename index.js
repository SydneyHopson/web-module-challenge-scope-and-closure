...
/*Task 1: counterMaker()
  ...
  counter1 code is returning a function that counts and is a closed container. counter2 is returning just a count value from mulitple locations refrencing its value on the exterior.
  2. Which of the two uses a closure? How can you tell?
  counter1 uses closure it starts at the bracket on 41 and ends at the brackets on 43.
  3. In what scenario would the counter1 code be preferable? In what scenario would 
     counter2 be better?  counter1 would best be used if all 
  counter1 would be used in a scenario where you all the variables are  contained in one scope.
  counter2 would be best used when outside variables need to be referenced inside of your scope.
*/
...
if(homeScore === awayScore){
 scoreByinnings.push(`This game will require extra innings: Away ${currentInning.Away} - Home ${currentinnings.Home}`) 
}else{
  scoreByinnings.push(`Final Score: Home: ${homeScore} - Away: ${awayScore}`)}
 }
